...
export class WidgetsDropdownComponent implements OnInit, AfterContentInit {
  ...
  constructor(
    private changeDetectorRef: ChangeDetectorRef, private customerService: CustomerService, private expService: ExpendituresService,
    private paymentService: PaymentsService, private packageService: PackagesService
  ) {}
  ...
  ngOnInit(): void {
    ...
    this.paymentService.getAllPaymentsDisplay(client_id).subscribe((result: Payments[])=>{
      ...
      this.totalPayments = this.allPayments.length;
    });
    this.expService.getAllExpendituresDisplay(client_id).subscribe((result: Expenditures[])=>{
      this.allExpenditures = result;
      this.totalExpenditures = this.allExpenditures.length;
    });
  }
